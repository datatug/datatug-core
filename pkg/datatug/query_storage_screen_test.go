...
func storageScreenCases() []storageScreenCase {
	...
	return []storageScreenCase{
		...
		set("recordsets[0].alternateKeys[0].name", func(q *QueryDef) { rs(q).AlternateKeys[0].Name = storageCredentialValue }),
		set("recordsets[0].alternateKeys[0].columns[0]", func(q *QueryDef) { rs(q).AlternateKeys[0].Columns[0] = storageCredentialValue }),
