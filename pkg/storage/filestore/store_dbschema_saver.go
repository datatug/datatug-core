...
//)
//
//func (s fsDbCatalogStore) saveDbSchemas(schemas []*datatug.DbSchema, dbServerSaverCtx saveDbServerObjContext) error {
...
//}
//
//func (s fsDbCatalogStore) saveDbSchema(dbSchema *datatug.DbSchema, dbServerSaverCtx saveDbServerObjContext) error {
...
//}
//
//func (s fsDbCatalogStore) saveTables(tables []*datatug.CollectionInfo, save saveDbServerObjContext) error {
...
//}
//
//func (s fsDbCatalogStore) saveTable(table *datatug.CollectionInfo, save saveDbServerObjContext) (err error) {
...
//}
//
//func (s fsDbCatalogStore) writeTableReadme(table *datatug.CollectionInfo, save saveDbServerObjContext) func() error {
//	return func() error {
