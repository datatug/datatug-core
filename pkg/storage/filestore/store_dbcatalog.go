...
//)
//
//var _ datatug.DbCatalogsStore = (*fsDbCatalogStore)(nil)
//
...
//}
//
//func (s fsDbCatalogStore) CatalogID() string {
//	return s.catalogID
//}
//
...
//func (s fsDbCatalogStore) saveDbCatalogObjects(dbCatalog datatug.DbCatalog, saverCtx saveDbServerObjContext) error {
...
//}
//
//func (s fsDbCatalogStore) saveDbCatalogRefs(dbCatalog datatug.DbCatalog, saverCtx saveDbServerObjContext) error {
