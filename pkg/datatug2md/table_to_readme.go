...
func getTableData(repository *datatug.ProjectRepository, catalog string, table *datatug.CollectionInfo, dbServer datatug.ProjDbServer) (data map[string]interface{}, err error) {
